...
/**
 * 예전 redirect URI(`/oauth/naver/login`)로 돌아오는 요청을 `/naver/callback`으로 넘깁니다.
 */
export default function NaverLoginLegacyRedirectPage() {
  ...
  useEffect(() => {
    ...
    void router.replace(`/naver/callback${query}`);
